...
<?php echo form_open('siswakelas/create/'.$siswa_id, 'class="form-horizontal"') ?>
<div class="control-group <?php if (($this->session->flashdata('siswa_id'))) echo 'error'; ?>">
    ...
    <div class="controls">
        <label class="checkbox" for="siswa_id"><?php echo $siswa_nama ?></label>
...
<div class=" form-actions">
    ...
    <a href="<?php echo site_url('siswas/'.$siswa_id) ?>" class="btn">Kembali</a>
</div>
</form>
