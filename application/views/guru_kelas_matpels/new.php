...
<?php echo form_open('gurukelasmatpels/create/'.$guru_id, 'class="form-horizontal"') ?>
        ...
        <select class="span2" name="guru_mata_pelajaran_id">
            <?php if (!empty($guru_mata_pelajarans)) { ?>
                <?php foreach ($guru_mata_pelajarans as $guru_mata_pelajaran): ?>
                    <option value="<?php echo $guru_mata_pelajaran['id'] ?>" <?php echo $guru_mata_pelajaran_id === $guru_mata_pelajaran['id'] ? "selected" : "" ?>><?php echo get_full_mata_pelajaran($guru_mata_pelajaran['mata_pelajaran_id']) ?></option>
                <?php endforeach; ?>
            <?php }else { ?>
                    <option value=""> </option>
            <?php } ?>
